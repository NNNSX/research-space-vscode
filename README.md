...
3. 选择下载的 `research-space-2.2.1-alpha.10.vsix`。
4. 打开一个文件夹后，点击左侧活动栏的 **Research Space** 图标开始使用。

也可以用命令行安装：

```bash
code --install-extension research-space-2.2.1-alpha.10.vsix --force
```
...
当前版本：**v2.2.1-alpha.10**（2026-04-24）
